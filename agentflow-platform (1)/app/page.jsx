...
export default function AgentFlowPlatform() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const formatted = `✅ File: ${data.filename}\n\n💡 Code:\n${data.code}`
      setResponse(formatted)
      console.log(data)
    } catch (error) {
      console.error("Error:", error)
      setResponse("❌ Error: Could not reach Flask backend or bad response")
    } finally {
      setIsLoading(false)
    }
  }
        ...
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          {response && (
            <Card className="border-0 shadow-lg bg-white/70 backdrop-blur-sm">
              ...
              <CardContent>
                <div className="p-4 bg-green-50 rounded-lg border border-green-200 whitespace-pre-wrap text-sm font-mono">
